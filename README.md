...
- Cursor: `anysphere.cursorpyright`, `anysphere.remote-ssh`
- Devin: `codeium.windsurfpyright`
- Visual Studio Code: `ms-vscode.cpp-devtools`, `ms-dotnettools.csdevkit`, `ms-dotnettools.csharp`, `ms-python.vscode-pylance`
